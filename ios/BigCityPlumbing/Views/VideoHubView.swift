...
private struct SingleVideoWebView: UIViewRepresentable {
    ...
    func updateUIView(_ webView: WKWebView, context: Context) {
        ...
        // IFrame API with controls:0 hides YouTube's logo and title. A transparent
        // tap layer over the player toggles play/pause AND swallows every tap so
        // nothing (logo, "Watch on YouTube", end-screen links) can navigate out.
        let html = """
        <!doctype html>
        <html>
        <head>
